...
/// This task is called from the common/.git/hooks/pre-commit.bash.
@Task()
//@Depends(analyze, unittest, format)
...
/// Runs all the unit tests in common/test
@Task('Unit Testing...')
...
/// Format all dart sources in Common package.
...
/// The default path for common docs output
String dartDocPath = 'C:/odw/sdk/doc/common';

/// The default directory for common docs output
Directory dartDocDir = new Directory('C:/odw/sdk/doc/common');

/// Generate Documentation for Common package.
@Task('DartDoc')
void tester() {
...
/// Run dartdoc on common and put in [dartDocPath].
@Task('DartDoc')
void dartdoc() {
  log('Generating Documentation...');
...
/// Build the Common package producing JavaScript files.
...
/// Compile the Common package using Dart Development Compiler (dartdevc).
...
/// Clean the Common package. Used beform [release].
@Task('Cleaning...')
void clean() {
  log("Cleaning...");
  delete(buildDir);
